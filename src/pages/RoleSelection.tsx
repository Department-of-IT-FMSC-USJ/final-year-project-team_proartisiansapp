...
export default function RoleSelection() {
  ...
  const handleSelect = (role: "buyer" | "seller") => {
    ...
    if (role === "seller") {
      ...
      // For now, only seller flow is fully implemented as requested
      navigate("/dashboard");
    }
  };
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-surface overflow-x-hidden max-w-md mx-auto">
      <header className="flex items-center p-4 pb-2 sticky top-0 z-10">
        ...
        <h2 className="text-on-surface text-[10px] font-bold uppercase tracking-[0.2em] flex-1 text-center pr-12">Join Pro-Artisan</h2>
      </header>

      <div className="flex flex-col items-center px-4 pt-10 pb-8">
        <h1 className="text-on-surface tracking-tight text-3xl font-bold leading-tight text-center pb-3">Choose your role</h1>
        <p className="text-on-surface-variant text-base font-normal leading-normal text-center">How would you like to use our marketplace?</p>
      </div>
          ...
          <div className="flex flex-col gap-6 p-6">
            <div className="space-y-2">
              ...
              <p className="text-on-surface-variant text-sm leading-relaxed">
                Browse and purchase unique, handmade artisan products from creators around the world.
              </p>
            </div>
        ...
        >
          ...
          <div className="flex flex-col gap-6 p-6">
            <div className="space-y-2">
              ...
              <p className="text-on-surface-variant text-sm leading-relaxed">
                Sell your handmade products, manage your inventory, and grow your artisan business.
              </p>
            </div>
      ...
      <footer className="p-6 text-center">
        <p className="text-outline text-xs">
          By continuing, you agree to our <a className="underline hover:text-primary-container" href="#">Terms of Service</a> and <a className="underline hover:text-primary-container" href="#">Privacy Policy</a>.
        </p>
      </footer>
    </div>
  );
